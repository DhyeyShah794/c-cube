    ...
    return (
        <div className="donate">
            ...
            <div className="donation-info">
                <p className="d-text">
                    This club is for Holistic development of youth. College
education usually harps on the
first two aspects, while
association with an organization
such as C-Cube helps in fulfilling
the remaining one so show your support for the club by donating !
                    Your small contribution would count to a huge contribution and growth of the organisation and learning of individuals.
                
                  This will also benefit the community which we
            ...
            <div class="info">
                <h2>How to Donate?</h2>
                    <p>If you want to donate follow the read this before filling the form .
                        <br /><br />
                      Fill all your specified details in the form and make sure a proper email address is provided and submit it .
                      <br /><br />
                      You will recieve a mail with a link to pay which would be safe and secure to continue the transaction.
                    </p>
            </div>
